...
class __TwigTemplate_2e0ba9267fc499469a1f2cfe10e5344f extends Template
{
    ...
    <div class=\"row mb-4 justify-content-center\">
        ...
        // line 13
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 13, $this->source); })()), "request", [], "any", false, false, false, 13), "query", [], "any", false, false, false, 13), "get", ["min"], "method", false, false, false, 13), "html", null, true);
        yield "\">
                </div>
                <div class=\"form-group me-3 w-100\">
                    <input type=\"number\" name=\"max\" id=\"max-price\" class=\"form-control form-control-sm w-50\" placeholder=\"Prix maximum\" step=\"0.01\" value=\"";
        // line 16
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 16, $this->source); })()), "request", [], "any", false, false, false, 16), "query", [], "any", false, false, false, 16), "get", ["max"], "method", false, false, false, 16), "html", null, true);
        yield "\">
                </div>
    ...
    <div class=\"row row-cols-1 row-cols-md-3 g-3\">
        ...
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["produits"]) || array_key_exists("produits", $context) ? $context["produits"] : (function () { throw new RuntimeError('Variable "produits" does not exist.', 26, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["produit"]) {
            ...
            yield "            <div class=\"col mb-4\">
                <div class=\"card shadow-sm rounded border-0\">
                    <img src=\"";
            // line 29
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/produits/" . CoreExtension::getAttribute($this->env, $this->source, $context["produit"], "imageUrl", [], "any", false, false, false, 29))), "html", null, true);
            yield "\" class=\"card-img-top\" alt=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["produit"], "nom", [], "any", false, false, false, 29), "html", null, true);
            yield "\" style=\"height: 180px; object-fit: cover;\">
                    <div class=\"card-body d-flex flex-column p-3\">
                        <h5 class=\"card-title text-center text-truncate\">";
            // line 31
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["produit"], "nom", [], "any", false, false, false, 31), "html", null, true);
            yield "</h5>
    ...
    <div class=\"mt-3 text-center\">
        <!-- Link that redirects to the 'new' Commande route -->
        <a href=\"";
        // line 46
...
";
    ...
    {
        return array (  179 => 46,  172 => 41,  156 => 35,  151 => 33,  147 => 32,  143 => 31,  136 => 29,  132 => 27,  128 => 26,  115 => 16,  109 => 13,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% endblock %}
", "store/products.html.twig", "C:\\Users\\eyane\\Desktop\\symfoni crud 2\\gestioncommande\\templates\\store\\products.html.twig");
    }
}
