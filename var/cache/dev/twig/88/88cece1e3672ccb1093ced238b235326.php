...
class __TwigTemplate_5219c0ba975abcc67439854074f0fac3 extends Template
{
    ...
    <div class=\"card shadow-sm p-4\">
        ...
        yield "\" class=\"btn btn-link\">← Retour à la liste des produits</a>
        </div>
    </div>
</div>
";
...
<div class=\"container mt-5\">
    ...
    <div class=\"card shadow-sm p-4\">
        ...
        <!-- Link to go back to the product list -->
        <div class=\"mt-3 text-center\">
            <a href=\"{{ path('app_produit_index') }}\" class=\"btn btn-link\">← Retour à la liste des produits</a>
        </div>
    </div>
</div>
{% endblock %}
", "produit/new.html.twig", "D:\\fac\\web project\\eya nefzi 3A\\PlanmasterSymfony-commande\\templates\\produit\\new.html.twig");
    }
}
